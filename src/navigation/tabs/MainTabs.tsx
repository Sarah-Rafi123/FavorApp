...
const HomeIcon = ({ focused }: { focused: boolean }) => (
  <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <Path
      ...
      stroke={focused ? "#44A27B" : "#9CA3AF"}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
      fill={focused ? "#44A27B" : "none"}
    />
    <Path
      d="M9 22V12H15V22"
      stroke={focused ? "white" : "#9CA3AF"}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
...
const LocationIcon = ({ focused }: { focused: boolean }) => (
  <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <Path
  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: () => (
            <View className="w-16 h-16 bg-green-500 rounded-full items-center justify-center -mt-6">
              <PlusIcon />
            </View>
          ),
          tabBarLabel: '',
